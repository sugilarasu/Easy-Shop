...
export const metadata: Metadata = {
  title: 'Careers - E-Clone',
  description: 'Explore career opportunities at E-Clone and join our innovative team.',
};
      ...
      <Card className="shadow-lg overflow-hidden">
        <CardHeader className="bg-gradient-to-r from-primary to-primary/80 text-primary-foreground p-8 md:p-12 text-center">
          ...
          <CardDescription className="text-xl md:text-2xl mt-2 text-primary-foreground/90 max-w-3xl mx-auto">
            Be a part of E-Clone and help shape the future of e-commerce. We&apos;re looking for talented individuals to grow with us.
          </CardDescription>
        </CardHeader>
        <CardContent className="p-6 md:p-8">
          <section className="my-8">
            <h2 className="text-2xl md:text-3xl font-semibold text-center mb-8">Why Work at E-Clone?</h2>
          ...
          <section className="my-12">
            ...
            {jobOpenings.length > 0 ? (
              ...
              <p className="text-center text-muted-foreground">
                ...
                Feel free to send your resume to <a href="mailto:careers@eclone.example.com" className="text-primary hover:underline">careers@eclone.example.com</a>.
              </p>
            )}
          </section>
          ...
          <div className="text-center mt-12">
            ...
            <Button size="lg" className="mt-2 bg-primary hover:bg-primary/90">
              <Link href="mailto:careers@eclone.example.com">Submit Your Resume</Link>
            </Button>
          </div>
        </CardContent>
      </Card>
